  ...
  <div class="index">
    ...
    <div class="container">
    	...
    	<div class="row">
            <div class="col-md-12">
                <table class="table">
                    <caption>大唐运维物料2017年数据分析</caption>
                    <thead>
                        <tr>
                            <th>盟市</th>
    ...
    <!-- Modal -->
    <div class="modal fade" id="myModalComp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">盟市详情</h4>
          </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="myModalCounty" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">物资明细</h4>
          </div>
          <div class="modal-body content">
            <div style="height:430px;overflow-y:scroll;">
                <table class="table">
...
export default {
  ...
  methods:{
    ...
    groupByAfter(obj,sumField){
        ...
        _.forIn(obj,(v,k)=>{
            if (sumField) {
                let value=_.reduce(_.pluck(v,sumField),(total,next)=>total+=next)
